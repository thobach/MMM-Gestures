...
Note: If you use a Raspberry Pi 3 (vs. 2), e.g. on Raspbian Stretch, you may need to change the USB device name in https://github.com/thobach/MMM-Gestures/blob/master/node-helper.js#L104 from `ACM` to `USB`.
