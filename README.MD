...
2. Follow below steps to install the Gestures Node.js App and add the module to your Magic Mirror configuration
...
To start the Gestures Node.js App run: node "MMM-Gestures/Node.js/gestures.js".
